...
#Esta estrutura é para corrigir a forma que o lexico() foi implementado. Verificando a parte dois do trabalho, verifiquei que sempre vai passar um token, porém para ;, ( e ) passa o próprio lexema.
fila_lexico = []
